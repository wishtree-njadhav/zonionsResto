...
// import { LayoutConfigService, SparklineChartOptions } from 'src/app/core/_base/layout';
...
export class AdminDashboardComponent {
	...
	// ngOnInit(): void {
	// 	this.chartOptions1 = {
	// 		data: [10, 14, 18, 11, 9, 12, 14, 17, 18, 14],	// 		color: this.layoutConfigService.getConfig('colors.state.brand'),
	// 		border: 3
	// 	};
	// 	this.chartOptions2 = {
